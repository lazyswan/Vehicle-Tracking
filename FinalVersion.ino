...
void sendSMS(String message )
{
  ...
  delay(1500); //VERY IMP
  SIM900.println("AT + CMGS = \"+918080613642\"");                                     // recipient's mobile number, in international format
  delay(2000);
           ...
           // SDGPS.println("ring!");
            if (numring==comring)
            {
              ...
              gps.f_get_position(&lat, &lon);
               ...
               textForSMS = "Your Cordinates are : ";
...
if ( SDGPS.available() > 0 ) // if there is data coming into the serial line
{
  
byte a = SDGPS.read(); // get the byte of data
